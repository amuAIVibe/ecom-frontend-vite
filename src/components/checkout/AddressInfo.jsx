...
import { deleteUserAddres } from '../../store/actions';
      ...
      {noAddressExist ? (
        <div className="p-6 rounded-lg max-w-md mx-auto flex flex-col items-center justify-center">
          ...
          <button
            ...
            className="px-4 py-2 bg-blue-600 text-white font-medium rounded hover:bg-blue-700 transition duration-75"
          >
            Add Address
          </button>
        </div>
