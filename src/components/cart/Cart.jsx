...
const Cart = () => {
 ...
 const newCart = { ...cart }; // this is to ensure the state object immutability
 ...
 return (
    <div className="lg:px-14 sm:px-8 px-4 py-18">
        ...
        <div className="border-t-[1.5px] border-slate-200 py-4 flex sm:flex-row 
          sm:px-0 px-2 flex-col sm:justify-between gap-4">
            <div></div>
            <div className="flex text-sm gap-1 flex-col">
                ...
                <Link className="w-full flex justify-end" to="/checkout">
                    <button 
                     ...
                     flex items-center justify-center gap-2 hover:text-gray-300 transition duration-500"
                    >
