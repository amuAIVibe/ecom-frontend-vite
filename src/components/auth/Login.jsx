...
import { authenticatetSignInUser } from "../../store/actions/index.js";
...
const Login = () => {
    ...
    const loginHandler = async (data) => {
        //console.log("Login");
        dispatch(authenticatetSignInUser(data, toast, reset, navigate, setLoader));
    };
            ...
            >
                ...
                <button
                    ...
                    className="bg-button-gradient flex gap-2 items-center justify-center font-semibold
                     text-white w-full py-2 hover:text-slate-400 transition-colors duration-75 rounded-sm my-3"
                    type="submit"
                >
                    {loader ? (
                        <><Spinners/></>
